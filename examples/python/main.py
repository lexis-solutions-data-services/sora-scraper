"""
Example: How to call the sora-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/sora-scraper
...
def run_actor():
    """Run the sora-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/sora-scraper"
